          ...
          >
            ...
            <div className="p-8">
              ...
              <a
                ...
                className="flex items-center justify-center gap-3 w-full bg-stone-900 hover:bg-stone-700 text-white py-4 rounded-2xl font-black text-xs uppercase tracking-widest transition-all shadow-[0_10px_20px_rgba(0,0,0,0.3)] hover:shadow-[0_15px_30px_rgba(0,0,0,0.4)] hover:-translate-y-1"
              >
